...
use FightTheIce\Primitives\UnicodeString_ as String_;
use PHPUnit\Framework\TestCase;

class UnicodeString_Test extends TestCase
{
    ...
    {
        $str = new String_('This is a déjà-vu situation.');
        $this->assertSame('This is a déjà-vu situation.', $str->__toString());
    ...
    {
        $value = '     This is a déjà-vu situation.';
        $str1  = new String_($value);
        $str2  = $str1->ltrim();
        $this->assertSame('This is a déjà-vu situation.', $str2->__toString());
        $this->assertInstanceOf(\FightTheIce\Primitives\UnicodeString_::class, $str2);
        $this->assertNotSame($str1, $str2);
    }

    public function test_ltrim_with_character_mask()
    {
        $value = 'zzzThis is a déjà-vu situation.';
        $str1  = new String_($value);
        $str2  = $str1->ltrim('z');
        $this->assertSame('This is a déjà-vu situation.', $str2->__toString());
        $this->assertInstanceOf(\FightTheIce\Primitives\UnicodeString_::class, $str2);
    ...
    {
        $value = 'This is a déjà-vu situation.zzzz';
        $str1  = new String_($value);
        $str2  = $str1->rtrim('z');
        $this->assertSame('This is a déjà-vu situation.', $str2->__toString());
        $this->assertInstanceOf(\FightTheIce\Primitives\UnicodeString_::class, $str2);
    ...
    {
        $value = 'zzzzzzThis is a déjà-vu situation.zzzzz';
        $str1  = new String_($value);
        $str2  = $str1->trim('z');
        $this->assertSame('This is a déjà-vu situation.', $str2->__toString());
        $this->assertInstanceOf(\FightTheIce\Primitives\UnicodeString_::class, $str2);
